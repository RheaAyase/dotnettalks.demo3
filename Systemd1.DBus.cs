...
namespace Systemd1.DBus
{
    ...
    interface IManager : IDBusObject
    {
        ...
        Task<Unit[]> ListUnitsFilteredAsync(string[] arg0);
        Task<Unit[]> ListUnitsByPatternsAsync(string[] arg0, string[] arg1);
        Task<Unit[]> ListUnitsByNamesAsync(string[] arg0);
        ...
        Task<IDisposable> WatchUnitNewAsync(Action<(string, ObjectPath)> action);
        Task<IDisposable> WatchUnitRemovedAsync(Action<(string, ObjectPath)> action);
        Task<IDisposable> WatchJobNewAsync(Action<(uint, ObjectPath, string)> action);
        Task<IDisposable> WatchJobRemovedAsync(Action<(uint, ObjectPath, string, string)> action);
        Task<IDisposable> WatchStartupFinishedAsync(Action<(ulong, ulong, ulong, ulong, ulong, ulong)> action);
        Task<IDisposable> WatchUnitFilesChangedAsync(Action action);
        Task<IDisposable> WatchReloadingAsync(Action<bool> action);
    ...
    interface IScope : IDBusObject
    {
        Task AbandonAsync();
        Task<(string, uint, string)[]> GetProcessesAsync();
        Task<IDisposable> WatchRequestStopAsync(Action action);
        Task<T> GetAsync<T>(string prop);
